 ...
 *       Filename:  evbuffer.h
 *
 *    Description:  simple wrapper of evbuffer from libevent library.
 *
 *        Version:  1.0
 *        Created:  05/02/2012 09:55:28 AM
 *       Revision:  none
 *       Compiler:  gcc
 *
...
/**
  ...
  Expands the available space in the event event buffer to at least datlen
...
/**
  ...
  @param len the number of bytes to drain from the beginning of the evbuffer
  */
...
/**
  ...
  The evbuffer will be drained after the bytes have been successful writtent.
...
/**
  ...
  @param cbarg an argument to be providered to the callback function
 */
